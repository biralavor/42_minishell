...
SRC_FILES				= 01.main.c
SRC_FILES				+= 02.env_init.c
SRC_FILES				+= 03.env_init_utils.c
SRC_FILES				+= 04.loop_routine.c
SRC_FILES				+= ./01_lexer/05.check_initial_errors.c
SRC_FILES				+= ./01_lexer/06.token_list_functions.c
SRC_FILES				+= ./01_lexer/07.get_state.c
SRC_FILES				+= ./01_lexer/08.state10_to_state30.c
SRC_FILES				+= ./01_lexer/09.state40_to_state60.c
SRC_FILES				+= ./01_lexer/10.state61_to_state90.c
SRC_FILES				+= ./01_lexer/11.error_manager_lexer.c
SRC_FILES				+= ./01_lexer/12.lexer_utils.c
SRC_FILES				+= ./02_parser/13.syntax_analysis.c
SRC_FILES				+= ./02_parser/14.state100.c
SRC_FILES				+= ./02_parser/15.state200_to_state300.c
SRC_FILES				+= ./02_parser/16.check_redirects.c
SRC_FILES				+= ./02_parser/17.check_redirects_utils.c
SRC_FILES				+= ./02_parser/18.error_manager_parser.c
SRC_FILES				+= ./02_parser/19.manage_heredoc.c
SRC_FILES				+= ./03_binary_tree/20.building_tree.c
SRC_FILES				+= ./03_binary_tree/21.building_tree_utils.c
SRC_FILES				+= ./04_tree_execution/22.tree_execution.c
SRC_FILES				+= ./04_tree_execution/23.tree_execution_utils.c
SRC_FILES				+= ./04_tree_execution/24.manage_or_and.c
...
SRC_FILES				+= ./06_builtins/35.builtins_detectors.c
SRC_FILES				+= ./06_builtins/36.builtins_manager.c
SRC_FILES				+= ./06_builtins/builtin_echo.c
SRC_FILES				+= ./06_builtins/builtin_cd.c
SRC_FILES				+= ./06_builtins/builtin_pwd.c
SRC_FILES				+= ./06_builtins/builtin_export.c
SRC_FILES				+= ./06_builtins/builtin_export_utils.c
SRC_FILES				+= ./06_builtins/builtin_unset.c
SRC_FILES				+= ./06_builtins/builtin_env.c
SRC_FILES				+= ./06_builtins/builtin_utils.c
SRC_FILES				+= ./06_builtins/builtin_exit.c
SRC_FILES				+= ./06_builtins/builtin_cd_utils.c
SRC_FILES				+= ./06_builtins/builtin_exit_utils.c
