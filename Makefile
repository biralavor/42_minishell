...
SRC_FILES				+= ./lexer/05.check_initial_errors.c
SRC_FILES				+= ./lexer/06.token_list_functions.c
SRC_FILES				+= ./lexer/07.get_state.c
SRC_FILES				+= ./lexer/08.state10_to_state30.c
SRC_FILES				+= ./lexer/09.state40_to_state60.c
SRC_FILES				+= ./lexer/10.state61_to_state90.c
SRC_FILES				+= ./lexer/11.error_manager_lexer.c
SRC_FILES				+= ./lexer/12.lexer_utils.c
SRC_FILES				+= ./parser/13.syntax_analysis.c
SRC_FILES				+= ./parser/14.state100.c
SRC_FILES				+= ./parser/15.state200_to_state300.c
SRC_FILES				+= ./parser/16.check_redirects.c
SRC_FILES				+= ./parser/17.check_redirects_utils.c
