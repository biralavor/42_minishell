...
SRC_FILES				+= ./04_tree_execution/28.manage_single_cmd.c
SRC_FILES				+= ./05_expansions/29.expansion_manager.c
SRC_FILES				+= ./05_expansions/30.expansion_detectors.c
SRC_FILES				+= ./05_expansions/31.expansion_quotes.c
SRC_FILES				+= ./05_expansions/32.expansion_tilde.c
SRC_FILES				+= ./05_expansions/33.expansion_env_var.c
SRC_FILES				+= ./05_expansions/34.expansion_env_var_utils.c
SRC_FILES				+= ./05_expansions/35.expansion_question.c
SRC_FILES				+= ./06_builtins/36.builtins_detectors.c
SRC_FILES				+= ./06_builtins/37.builtins_manager.c
SRC_FILES				+= ./06_builtins/38.builtin_utils.c
SRC_FILES				+= ./06_builtins/39.builtin_echo.c
SRC_FILES				+= ./06_builtins/40.builtin_cd.c
SRC_FILES				+= ./06_builtins/41.builtin_cd_utils.c
SRC_FILES				+= ./06_builtins/42.builtin_pwd.c
SRC_FILES				+= ./06_builtins/43.builtin_export.c
SRC_FILES				+= ./06_builtins/44.builtin_export_utils.c
SRC_FILES				+= ./06_builtins/45.builtin_unset.c
SRC_FILES				+= ./06_builtins/46.builtin_env.c
SRC_FILES				+= ./06_builtins/47.builtin_exit.c
SRC_FILES				+= ./06_builtins/48.builtin_exit_utils.c
SRC_FILES				+= ./07_command_execution/49.command_runner.c
SRC_FILES				+= ./07_command_execution/50.command_runner_utils.c
