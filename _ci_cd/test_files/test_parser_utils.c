...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/02 00:41:54 by umeneses          #+#    #+#             */
/*   Updated: 2024/07/02 07:55:20 by umeneses         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
MU_TEST(testing_something)
{
	...
	xpect_node_02_type = get_token_string(AND);
...
MU_TEST_SUITE(testing_double_ampersand_suite)
{
	MU_RUN_TEST(testing_something);
}
