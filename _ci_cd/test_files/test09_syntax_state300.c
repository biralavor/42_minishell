...
/*   Updated: 2024/07/08 18:18:24 by umeneses         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
MU_TEST(testing_syntax_state300_REDIRECT_INPUT_simple_space_last_node)
{
	...
	open_redirect_stderr_to_dev_null(fd);
	userinput = "Mussum|Ipsum<";
	xpect_syntax_validation = 300; // ending with redirect input
	xpect_lst_size = 4;
	idx = 0;
	lst = NULL;
	get_state(idx, userinput, &lst);
...
MU_TEST(testing_syntax_state300_REDIRECT_OUTPUT_simple_space_last_node)
{
	...
	open_redirect_stderr_to_dev_null(fd);
	userinput = "Mussum|Ipsum >";
	xpect_syntax_validation = 300; // ending with redirect output
	xpect_lst_size = 4;
	idx = 0;
	lst = NULL;
	get_state(idx, userinput, &lst);
...
MU_TEST(testing_syntax_state300_REDIRECT_OUTPUT_APPEND_simple_space_last_node)
{
	...
	open_redirect_stderr_to_dev_null(fd);
	userinput = "Mussum|Ipsum>>";
	xpect_syntax_validation = 300; // ending with redirect output append
	xpect_lst_size = 4;
	idx = 0;
	lst = NULL;
	get_state(idx, userinput, &lst);
...
MU_TEST(testing_syntax_state300_REDIRECT_HEREDOC_simple_space_last_node)
{
	...
	open_redirect_stderr_to_dev_null(fd);
	userinput = "Mussum|Ipsum<<";
	xpect_syntax_validation = 300; // ending with redirect heredoc
	xpect_lst_size = 4;
	idx = 0;
	lst = NULL;
	get_state(idx, userinput, &lst);
...
MU_TEST_SUITE(test07___syntax_state300_REDIRECT_INPUT_errors_last_node_suite)
{
...
MU_TEST_SUITE(test07___syntax_state300_REDIRECT_OUTPUT_errors_last_node_suite)
{
...
MU_TEST_SUITE(test07___syntax_state300_REDIRECT_OUTPUT_APPEND_errors_last_node_suite)
{
...
MU_TEST_SUITE(test07___syntax_state300_REDIRECT_HEREDOC_errors_last_node_suite)
{
