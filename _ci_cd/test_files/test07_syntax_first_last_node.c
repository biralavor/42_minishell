...
/*   Updated: 2024/07/08 13:39:00 by umeneses         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
MU_TEST(testing_syntax_first_node_REDIRECT_OUTPUT_simple_space)
{
	// ARRANGE
	char			*userinput;
	int				idx;
...
MU_TEST(testing_syntax_first_node_REDIRECT_OUTPUT_space_after)
{
	// ARRANGE
	char			*userinput;
	int				idx;
...
MU_TEST(testing_syntax_first_node_REDIRECT_OUTPUT_space_before)
{
	// ARRANGE
	char			*userinput;
	int				idx;
...
MU_TEST(testing_syntax_first_node_REDIRECT_OUTPUT_APPEND_simple_space)
{
	// ARRANGE
	char			*userinput;
	int				idx;
...
MU_TEST(testing_syntax_first_node_REDIRECT_OUTPUT_APPEND_space_after)
{
	// ARRANGE
	char			*userinput;
	int				idx;
...
MU_TEST(testing_syntax_first_node_REDIRECT_OUTPUT_APPEND_space_before)
{
	// ARRANGE
	char			*userinput;
	int				idx;
...
MU_TEST(testing_syntax_first_node_REDIRECT_HEREDOC_simple_space)
{
	// ARRANGE
	char			*userinput;
	int				idx;
...
MU_TEST(testing_syntax_first_node_REDIRECT_HEREDOC_space_after)
{
	// ARRANGE
	char			*userinput;
	int				idx;
...
MU_TEST(testing_syntax_first_node_REDIRECT_HEREDOC_space_before)
{
	// ARRANGE
	char			*userinput;
	int				idx;
...
MU_TEST_SUITE(test07___syntax_first_node_REDIRECT_OUTPUT_errors_suite)
{
	MU_RUN_TEST(testing_syntax_first_node_REDIRECT_OUTPUT_simple_space);
	MU_RUN_TEST(testing_syntax_first_node_REDIRECT_OUTPUT_space_after);
	MU_RUN_TEST(testing_syntax_first_node_REDIRECT_OUTPUT_space_before);
}

MU_TEST_SUITE(test07___syntax_first_node_REDIRECT_OUTPUT_APPEND_errors_suite)
{
	MU_RUN_TEST(testing_syntax_first_node_REDIRECT_OUTPUT_APPEND_simple_space);
	MU_RUN_TEST(testing_syntax_first_node_REDIRECT_OUTPUT_APPEND_space_after);
	MU_RUN_TEST(testing_syntax_first_node_REDIRECT_OUTPUT_APPEND_space_before);
}

MU_TEST_SUITE(test07___syntax_first_node_REDIRECT_HEREDOC_errors_suite)
{
	MU_RUN_TEST(testing_syntax_first_node_REDIRECT_HEREDOC_simple_space);
	MU_RUN_TEST(testing_syntax_first_node_REDIRECT_HEREDOC_space_after);
	MU_RUN_TEST(testing_syntax_first_node_REDIRECT_HEREDOC_space_before);
}
