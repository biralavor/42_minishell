...
/*   Updated: 2024/08/29 18:18:52 by umeneses         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_lst_printer(t_token_list *lst)
{
	...
	fprintf(stderr, "|---|--------------|--------------|------------|------------|----------|\n");
	fprintf(stderr, "|idx| token lexeme |  token type  |    prev    |    next    | nxt char |\n");
	fprintf(stderr, "|---|--------------|--------------|------------|------------|----------|\n");
	while (aux)
	{
		fprintf(stderr, "|\033[0;31m%2d\033[0m | \033[0;32m%12s\033[0m | \033[0;36m%12s\033[0m | %10p | %10p | %8c |\n", aux->idx, aux->lexeme, get_token_string(aux->type), aux->prev, aux->next, aux->next_char);
		aux = aux->next;
	}
	fprintf(stderr, "|---|--------------|--------------|------------|------------|----------|\n\n");
	fflush(stderr);
